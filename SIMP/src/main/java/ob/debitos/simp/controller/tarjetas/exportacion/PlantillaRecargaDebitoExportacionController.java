...
@RequestMapping("/plantilla/lote/recargaDebito")
public @Controller class PlantillaRecargaDebitoExportacionController
{
    ...
    public ModelAndView descargarPlantillaAfiliacionLoteNominada(ModelMap model)
    {
        ...
        model.addAttribute(ReporteUtilYarg.PARAM_TEMPLATE, "plantillaLoteRecargaDebito");
        model.addAttribute(ReporteUtilYarg.PARAM_NOMBRE_REPORTE, "Planfilla para recarga y debitar tarjetas");
