...
public class PixelUtil {
	...
	public static final double WIDTH_HEIGHT_FACTOR = 2.442;
	...
	public static short heightUnits2widthUnits(short widthUnits) {
		return (short) (widthUnits * WIDTH_HEIGHT_FACTOR);
	}
