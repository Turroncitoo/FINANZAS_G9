...
public interface IInterfaceContableAlegraMapper {

	public List<InterfaceContableAlegraRequest> interfaceAlegraComisInCompras(CriterioBusquedaInterfaceContableAlegra criterio);

	public List<InterfaceContableAlegraRequest> interfaceAlegraComisOutCompras(CriterioBusquedaInterfaceContableAlegra criterio);

	public List<InterfaceContableAlegraRequest> interfaceAlegraCompOutAdquiCompras(CriterioBusquedaInterfaceContableAlegra criterio);
