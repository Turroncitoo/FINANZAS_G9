$(document).ready(function() {
	...
	$local.tablaMantenimiento = $local.$tablaMantenimiento.DataTable({
		"ajax" : {
			"url" : $variableUtil.root + "afinidad?accion=buscarTodos",
			"dataSrc" : ""
		},
		"language" : {
			"emptyTable" : "No hay afinidades registradas"
		},
	...
	$local.$modalMantenimiento.PopupWindow({
		title : "Mantenimiento de Afinidad",
		autoOpen : false,
		modal : false,
		height : 300,
		width : 700,
	...
	$local.$registrarMantenimiento.on("click", function() {
		...
		$.ajax({
			type : "POST",
			url : $variableUtil.root + "afinidad",
	...
	$local.$actualizarMantenimiento.on("click", function() {
		...
		var afinidad = $formMantenimiento.serializeJSON();
		afinidad.idAfinidad = $local.seleccionado.idAfinidad;
		afinidad.idLogo = $local.seleccionado.idLogo;
		afinidad.codigo = $local.seleccionado.codigo;
		$.ajax({
			type : "PUT",
			url : $variableUtil.root + "afinidad",
			data : JSON.stringify(afinidad),
	...
	$local.$tablaMantenimiento.children("tbody").on("click", ".eliminar", function() {
		...
		$.confirm({
			...
			title : "Aviso",
			content : "&iquest;Desea eliminar la Afinidad <b>'" + afinidad.codigo + " - " + afinidad.descripcionAfinidad + "'</b>?",
			buttons : {
				Aceptar : {
					action : function() {
							...
							content : function() {
								...
								$.ajax({
									...
									case 400:
										...
										break;
									case 409:
										var mensaje = $funcionUtil.obtenerMensajeError("La Afinidad <b>" + afinidad.codigo + " - " + afinidad.descripcionAfinidad + "</b>", xhr.responseJSON, $variableUtil.accionEliminado);
