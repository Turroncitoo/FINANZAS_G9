$(document).ready(function() {
	...
	$local.tablaMantenimiento = $local.$tablaMantenimiento.DataTable({
		...
		"columnDefs" : [ {
			...
			"width" : "10%",
			"render" : function() {
				return "" + ($local.permisoActualizacion == "true" ? $variableUtil.botonActualizar : "") + " " + ($local.permisoEliminacion == "true" ? $variableUtil.botonEliminar : "") + " " + ($local.permisoDetalle == "true" ? $variableUtil.botonAniadirDetalle : "");
			}
		} ],
		"columns" : [ {
			"data" : 'idTabla',
	...
	$local.$tablaMantenimiento.children("tbody").on("click", ".eliminar", function() {
		...
		$.confirm({
			...
			title : "Aviso",
			content : "&iquest;Desea eliminar la tabla <b>'" + multiTabCab.idTabla + " - " + multiTabCab.descripcion + "'</b>?",
			buttons : {
				Aceptar : {
					action : function() {
